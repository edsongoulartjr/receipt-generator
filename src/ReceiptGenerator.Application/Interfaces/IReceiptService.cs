...
{
    Task<PagedResponse<ReceiptResponse>> GetByUserIdAsync(int userId, int page, int pageSize, int? month = null, int? year = null, bool includeCancelled = false, CancellationToken cancellationToken = default);
    Task<PagedResponse<ReceiptResponse>> GetAllAsync(int page, int pageSize, int? month = null, int? year = null, bool includeCancelled = false, CancellationToken cancellationToken = default);
Task<ReceiptResponse?> GetByIdAsync(int id, int userId, CancellationToken cancellationToken = default);
    ...
    Task<bool> DeleteAsync(int id, int userId, string? reason = null, CancellationToken cancellationToken = default);
    Task<bool> DeleteByAnyIdAsync(int id, string? reason = null, CancellationToken cancellationToken = default);
